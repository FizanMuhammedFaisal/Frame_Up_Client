                  ...
                  {product.appliedDiscount && (
                    <div className="mt-2">
                      <p className="text-sm text-green-600 mb-1">
                        Discount:{" "}
                        <strong>{product.appliedDiscount.name}</strong> - Ends
                        on{" "}
                        {new Date(
                      ...
                      <div className="inline-flex items-center px-3 py-1 text-sm font-semibold text-white bg-green-800 rounded-full ">
