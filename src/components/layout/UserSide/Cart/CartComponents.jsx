  ...
  return (
    <div className="p-4 sm:p-8 text-center">
      ...
      <motion.button
        ...
        className="bg-customColorTertiary text-white py-2 px-4 sm:py-3 sm:px-6 rounded-md font-medium hover:bg-customColorTertiaryLight transition duration-150 ease-in-out"
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
      >
        Start Shopping
